    ...
    <>
      <div className="flex items-center justify-between gap-10">
        <div className="flex flex-col lg:flex-row items-center gap-6">
          ...
          >
            <button className="bg-primary rounded-lg px-6 py-2 border border-primary flex items-center gap-2 text-black font-bold text-md hover:bg-transparent hover:text-primary duration-300">
        ...
        <div className="relative w-2/4 lg:w-1/4">
          <div className="flex">
            <Input
              suffix={<FaSearch />}
              placeholder="Search..."
